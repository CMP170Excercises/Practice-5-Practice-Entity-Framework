...
namespace StudentManagement
{
    class StudentServiceWithEF : IStudentService
    {
        ...
        public SearchStudentViewModel.Student LoadStudentById(int id)
        {
            using (var ctx =new UniversityContext())
            {
        ...
        public IList<SearchStudentViewModel.Student> SearchStudent(string keyword, string hutechclass)
        {
            using (var ctx = new UniversityContext())
            {
